...
public final class HackRFDeviceQuery {
	...
	public static final class Info {
		...
		Info(int initResult, int openResult, String firmware, int usbApi, int boardId, String boardName,
				String libraryRelease, String libraryVersion) {
	...
	public static Info query() {
		...
		if (init != HACKRF_SUCCESS)
			return new Info(init, -1, null, 0, 0xFF, null, release, libVer);
		...
		if (open != HACKRF_SUCCESS)
			return new Info(init, open, null, 0, 0xFF, null, release, libVer);
		...
		try {
			...
			return new Info(init, open, firmware, usbApi, boardId, boardName, release, libVer);
		} finally {
