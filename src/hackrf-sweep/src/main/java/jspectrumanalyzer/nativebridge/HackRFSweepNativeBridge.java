...
//		Native.DEBUG_LOAD	= true;
			...
			int lna_gain, int vga_gain, boolean antennaPowerEnable, boolean antennaLNAEnable)
	{
		...
		HackrfSweepLibrary.hackrf_sweep_lib_start(callback, freq_min_MHz, freq_max_MHz, fft_bin_width, num_samples, lna_gain, vga_gain, antennaPowerEnable ? 1 : 0, antennaLNAEnable ? 1 : 0);
	}
