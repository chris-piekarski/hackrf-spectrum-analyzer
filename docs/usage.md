...
| Control | What it does |
|---|---|
| **LNA Gain / VGA Gain** | Analog gain on the radio. Start mid-range; raise LNA first if the noise floor is too low. |
...
| **Auto-scale dB axis** | Off (default): power scale stays **−100…+20**. On: fit the live band, 10 dB ticks, 20 dB pad. |
