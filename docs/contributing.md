...
Thank you for your interest in improving the HackRF Spectrum Analyzer!
...
2. Make your changes.
3. Add unit tests for any new core logic (see [development.md](development.md)).
4. Run `make test` and `make lint`.
5. Update documentation under `docs/` as needed.
